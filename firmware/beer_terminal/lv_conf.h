// Generated from lvgl 9.2.2 lv_conf_template.h. Only the marked options differ.
/**
 * @file lv_conf.h
...
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(font_de_20) LV_FONT_DECLARE(font_de_28) LV_FONT_DECLARE(font_de_32) LV_FONT_DECLARE(font_de_48)
